...
RUN  sed -i s@/archive.ubuntu.com/@/mirrors.aliyun.com/@g /etc/apt/sources.list && \
    ...
    apt-get -y install git python3 build-essential libssl-dev libffi-dev python3-pip python3-dev python3-pyaudio && \
    #清理缓存
    ...
    mkdir /root/.pip/ && echo "[global]">>/root/.pip/pip.conf && \ 
     ...
     echo "PYTHONPATH=$HOME/myapp/:$PYTHONPATH">>/etc/environment  && \
